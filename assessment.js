...
// #2 Use the variable iLove to create a new variable called iLoveCode 
//that is assigned the string "I love code"
var iLove = 'I love';
...
// #6 Loop through this object and change all keys that start with the letter 
// s to have a value of 's'
...
//#7 Create an array of strings that are the 7 primary colors in the rainbow - red, orange, yellow, green, blue, indigo, violet (lower-case). 
//Call your array rainbowColors
...
var flashLocator = heroes.indexOf('flash');
var secondHero = heroes.splice(flashLocator, 1);
